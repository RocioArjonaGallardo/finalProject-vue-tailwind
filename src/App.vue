  ...
  <div class="container px-4 mx-auto">
    <div class="max-w-sm mx-auto">
      ...
      <form action="">
        ...
        <a class="inline-block py-2 px-7 mb-6 w-full text-base text-green-50 font-medium text-center leading-6 bg-black hover:bg-green-600 focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 rounded-xl shadow-sm" href="#">Sign In</a>
        <p class="text-center">
          <span class="text-xs font-medium">Don’t have an account? </span>
          <a class="inline-block text-xs font-medium text-teal-600 hover:text-green-600 hover:underline" href="#"> Sign up</a>
        </p>
      </form>
    </div>
  </div>
